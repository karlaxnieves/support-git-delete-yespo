...
_“v=spf1 redirect=\_spf.google.com”_
...
We recommend that when working with our service using the basic connection option, add our insert to the SPF string of your domain “_include:spf2.esputnik.com_”.
