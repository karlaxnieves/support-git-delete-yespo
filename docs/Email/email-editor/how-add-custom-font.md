...
4. Add src to the file `stylesheet.css` to your server with the necessary font in the `woff2` format  (the script in this format would be in the kit), for example:
