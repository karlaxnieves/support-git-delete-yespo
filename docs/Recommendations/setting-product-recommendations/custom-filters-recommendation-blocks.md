...
1\. Go to the *Data Sources* tab in your account settings.

2\. Click *Add rules* on the data source, or edit a previously created rule.

<Image align="center" width="80% " src="https://files.readme.io/fc469130789153619651d6b04ad556ec0740e49e79e22dced6c7d42052c8ebf7-add_rules_12.webp" />

3\. Enter a name for the rules.

<Image align="center" width="80% " src="https://files.readme.io/60f07cce137df926cb164390f7f91ec44ea0e35fd54b7aaad7d9bc49838147d1-add_rules_2.webp" />
...
<Image align="center" width="80% " src="https://files.readme.io/d457785305fbac7f60563636702ce7c29b1ae8d04945393274886beda06dd7ed-add_rules_3.webp" />
...
1\. Click the *Add rule* button in the *Main rules* section.

<Image align="center" width="80% " src="https://files.readme.io/ad0a3bb58b5b7179935bd8d54c3bcbcaccd60c2008b998322bbebfea4fdb72db-add_rules_4.webp" />
...
<Image align="center" width="80% " src="https://files.readme.io/64d82ed81a913fa2bb64de8d56b4aa53a4f35d7a3104710fde8b5da2d87ce2e3-add_rules_5.webp" />

> 📘 Note
>
> Data source rules include the *Relative Range* option, which allows you to configure the display of products within the price range relative to the price of the specific product that the customer is viewing or to which the recommendation is linked. For example, if you set the range from 70% to 300%, and the user is viewing a product for $1000, the system will select products within the range from $700 to $3000.
>
> <Image align="center" width="80% " src="https://files.readme.io/1567cc65b5c0fda66939190a3a6473ee9b5b5225c0a945d538e63342dec8b713-range.png" />
...
<Image align="center" width="40% " src="https://files.readme.io/0a390804a2674fbef21eb7d0f29d028c7a4af1785cd8115106bb75ce6341ba9e-add_rules_6.webp" />

2\. Select the contact data field in the second column.

<Image align="center" width="80% " src="https://files.readme.io/960c5ade813c118650a8bd16fc2887cb68d83faadabdb7ff085f54d0b8362cda-add_rules_7.webp" />

3\. Select a field from the product feed in the last column.

<Image align="center" width="80% " src="https://files.readme.io/abe430e62aeda0b170d8940e025f912c1ca9872fc8b992a3034ca10e66dd17cf-add_rules_8.webp" />

Matching links the contact field and the product field in the feed. For example, the *size* in the contact field is equal to the *eu\_size* field in the feed.
...
1\. Click the arrow next to the description of conditional rules →  the *Add condition* button.

<Image align="center" width="80% " src="https://files.readme.io/0728c18f4df46aaaae7a3dace063a366d6811aecfde2a0e86ed5a56e45cac2bf-add_rules_9.webp" />

2\. Add *If* and *Then* conditions: for example, if the user viewed the *Bags* category, only show bestsellers from this category.

<Image align="center" width="80% " src="https://files.readme.io/e764fab7f9c226e7e58c539367c232b6ab8bae3492627900b69c6737f9da508d-add_rules_10.webp" />

## Saving Settings

When finished adding rules, click *Done* at the bottom of the page.

<Image align="center" width="80% " src="https://files.readme.io/047ca9559e6d70ca7a96516f5f5bc599fba72091649e7f4c4d945c8212b1560a-add_rules_11.webp" />

The rules you created will be displayed on the card of the data source to which they refer.

<Image align="center" width="80% " src="https://files.readme.io/f03e928f29655f0708d9825807cf1486aa26a123735ff5c8fc5219b1fbd9ce5c-add_rules_12.webp" />
