...
* *es\_link\_raw –`http://example.com/somelink`* – contains the original link that can be opened in the device’s browser or can be an internal link, directing to other app sections;
* *es\_link –`https://hh.esclick.me/37NdHw333DjRcukc0l`* – created based on the added link and contains a wrapped link used for click tracking.
