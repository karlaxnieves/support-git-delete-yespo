...
<Image align="center" src="https://files.readme.io/63b20cecbac7ddc131b259f8490abe60bff318eb2692655505ce834bbc443d1b-auth_token.png" />
...
<Image align="center" width="80%" src="https://files.readme.io/7abddd441ef6c836ae11abc31fc77a7503da2cb8426cb197a58f453b4f8572ed-image5.webp" />
...
```javascript
<script>!function (t, e, c, n) {var s = e.createElement(c); s.async = 1, s.src = 'https://scripts/' + n + '.js'; var r = e.scripts[0]; r.parentNode.insertBefore(s, r); var f = function () {f.c(arguments); }; f.q = []; f.c = function () {f.q.push(arguments); }; t['eS'] = t['eS'] || f; }(window, document, 'script', 'UUID');</script>
<script>eS('init', {getAuthTokenCallback: () => yourImplementationOfAuthCallback(), language: 'en'});</script>
```
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        function yourImplementationOfAuthCallback() { return new Promise((resolve, reject) => {
