...
1. Go to the *Contacts* tab → *All Contacts* and select a contact category from the left menu. By default, all categories are selected.
...
2. Go to the *Data tab → Get & Transform Data*, and select *From Text/CSV*.
