...
<Image align="center" width="80% " src="https://files.readme.io/782f9b2109b63014b40f24aa8f10beb56c9f08ee0ca6b60e0806ce8db2582a5d-message-event.webp" />
...
<Image align="center" width="80% " src="https://files.readme.io/2bd90c96d20f19ea21694a62003a2d1375ad3b558c4e6709e0dcaa861c161f21-event_count.webp" />
...
* **Message type:** Email, SMS, Web Push, Mobile Push, Viber, App Inbox, In-App (message type is not specified for the *Unsubscribe* and *Spam* events, since they can only occur in emails; for In-Apps, only the *Open*, *Click* and *Delivery error* events are available; for Telegram, only the *Send*, *Delivery*, *Click* and *Delivery error* events are available).
